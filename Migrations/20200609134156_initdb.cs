        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayType = table.Column<string>(type: "varchar(20)", nullable: false),
                    UnitName = table.Column<string>(type: "varchar(50)", nullable: false),
                    MemberTypes = table.Column<string>(type: "varchar(500)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkContentType = table.Column<string>(type: "text", nullable: false),
                    Departments = table.Column<string>(type: "text", nullable: false),
                    HolidayTypes = table.Column<string>(type: "text", nullable: false),
                    UnitNames = table.Column<string>(type: "text", nullable: false),
                    PayTableTypes = table.Column<string>(type: "text", nullable: false),
                    MemberPosts = table.Column<string>(type: "text", nullable: false),
                    MemberPartyPosts = table.Column<string>(type: "text", nullable: false),
                    ...
                    JobGrades = table.Column<string>(type: "text", nullable: false),
                    MemberTypes = table.Column<string>(type: "text", nullable: false),
                    NationTypes = table.Column<string>(type: "text", nullable: false),
                    PrizrOrPunishTypes = table.Column<string>(type: "text", nullable: false),
                    PrizrOrPunishNames = table.Column<string>(type: "text", nullable: false),
                    Relations = table.Column<string>(type: "text", nullable: false),
                    MemberScoreTypes = table.Column<string>(type: "text", nullable: false),
                    IntervalOne = table.Column<int>(nullable: false),
                    IntervalTwo = table.Column<int>(nullable: false),
                    Appraises = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(nullable: false),
                    MemberId = table.Column<string>(type: "varchar(20)", nullable: false),
                    NameAndAmount = table.Column<string>(type: "varchar(2000)", nullable: false),
                    TableType = table.Column<string>(type: "varchar(30)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dsMemberSalary", x => x.Id);
                    table.ForeignKey(
                        name: "FK_dsMemberSalary_dsMembers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "dsMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(nullable: false),
                    MemberId = table.Column<string>(type: "varchar(20)", nullable: false),
                    ScoreType = table.Column<string>(type: "varchar(30)", nullable: false),
                    Score = table.Column<int>(nullable: false),
                    OccurDate = table.Column<DateTime>(nullable: false),
                    MemberIndex = table.Column<int>(nullable: false),
                    ScoreUnitName = table.Column<string>(type: "varchar(50)", nullable: false),
                    UserId = table.Column<string>(type: "varchar(20)", nullable: false),
                    Remark = table.Column<string>(type: "varchar(300)", nullable: true),
                    UpDateTime = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_dsMemberScores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_dsMemberScores_dsMembers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "dsMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_dsMemberSalary_MemberId",
                table: "dsMemberSalary",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_dsMemberScores_MemberId",
                table: "dsMemberScores",
                column: "MemberId");
