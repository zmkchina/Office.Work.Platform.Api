...
namespace Office.Work.Platform.Api.Controllers
{
    ...
    public class MemberResumeController : ControllerBase
    {
        private readonly MemberResumeRepository _DataRepository;

        public MemberResumeController(GHDbContext ghDbContet, ILogger<User> logger)
        {
            _DataRepository = new MemberResumeRepository(ghDbContet);
        }
        /// <summary>
        /// 返回所有记录
        /// </summary>
        ...
        public async Task<string> PostAsync([FromForm]MemberResume EntityInfo)
        {
        ...
        /// <returns></returns>
        [HttpPut]
        public async Task<string> PutAsync([FromForm]MemberResume Entity)
        {
            ExcuteResult actResult = new ExcuteResult();
            if (Entity != null)
            {
