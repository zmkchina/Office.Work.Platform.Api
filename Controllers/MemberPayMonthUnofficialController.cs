...
namespace Office.Work.Platform.Api.Controllers
{
    ...
    public class MemberPayMonthUnofficialController : ControllerBase
    {
        ...
        public MemberPayMonthUnofficialController(GHDbContext ghDbContet)
        {
        ...
        public async Task<string> PostAsync([FromBody]MemberPayMonthUnofficial PEntity)
        {
        ...
        [HttpPut]
        public async Task<string> PutAsync([FromBody]MemberPayMonthUnofficial PEntity)
        {
            ExcuteResult actResult = new ExcuteResult();
